 ...
 *  texte. <p>
 *
 *  Cette classe permet de cr&eacute;er et manipuler des objets. 
 *
 * @author     Paris13
 * @version    1.0
...
public class ObjetZork
{
    ...
    /**
     *
     * initialise un ObjetZork qui est transportable<br>
    ...
    /**
     *
     * retourne la portabilit&eacute; de l'objet ObjetZork
     *
    ...
    /**
     *
     * v&eacute;rifie si le poids se situe entre 0 et 200
     * 
     ...
     * "ObjetZork" et qu'ils sont égaux 
     *
     *
     * @param ObjZ L'ObjetZork qu'on veut comparer
